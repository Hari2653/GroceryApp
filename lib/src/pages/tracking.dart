...
class _TrackingWidgetState extends StateMVC<TrackingWidget>
  ...
  Widget build(BuildContext context) {
    ...
    // print(_con.order.productOrders[0].product.market.rate);
    return Scaffold(
      appBar: AppBar(
      ...
      body: SafeArea(
          child: _con.order == null || _con.orderStatus.isEmpty
              ? Center(child: CircularLoadingWidget(height: 400))
                              ...
                              children: <Widget>[
                                Row(
                                  children: <Widget>[
                                    ...
                                    Helper.getPrice(
                                        _con.order.deliveryFee, context,
                                        style: Theme.of(context)
                                            .textTheme
                                            .subtitle1)
                                  ],
                    ...
                    children: <Widget>[
                      ...
                      MaterialButton(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children:
                              Helper.getStarsList(double.parse("4"), size: 35),
                        ),
                      ),
                    ],
                  ),
    ...
    //                                     //     ?
    //                                     Text(
    //                                   '${DateFormat('HH:mm | yyyy-MM-dd').format(_con.order.dateTime)}',
    //                                   style:
    ...
    //                                     child: Text(
    //                                       '${Helper.skipHtml(_con.order.hint)}',
    //                                     )),
    //                                 isActive: (int.tryParse(
